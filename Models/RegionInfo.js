export class RegionInfo {
    constructor(areaName, residentCount, houseCount, banCount, personcount, shipCount, 
        otherShipCount, motelCount, facilityCount, mannedCount, unMannedCount, 
        contactType1, contactName1, mobilePhone1, officePhone1,
        contactType2, contactName2, mobilePhone2, officePhone2,
        contactType3, contactName3, mobilePhone3, officePhone3,
        recordDataSun, recordDataMoon, order, note, imageLink
        ) {
